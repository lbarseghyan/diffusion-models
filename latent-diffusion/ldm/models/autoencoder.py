from packaging import version     # ADD #
...
class VQModel(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        # Forward pass: get reconstruction, codebook loss, and predicted indices.
        xrec, qloss, ind = self(x, return_pred_indices=True)
        ...
        # Compute autoencoder loss (optimizer index 0 previously)
        aeloss, log_dict_ae = self.loss(
            qloss, x, xrec, 0, self.global_step,
            last_layer=self.get_last_layer(), split="train",
            # predicted_indices=ind                            # Modified #
        )
        ...
        # Compute discriminator loss (optimizer index 1 previously)
        ...
        # Log the metrics. You can log each separately if desired.
        ...
        # Optionally, return the sum of the losses
