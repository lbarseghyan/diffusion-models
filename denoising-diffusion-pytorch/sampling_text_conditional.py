...
from denoising_diffusion.ddpm_text_new import Unet, GaussianDiffusion
from train.utils.data import TextConditionalDataset
...
config = '/home/user1809/Desktop/diffusion-models/denoising-diffusion-pytorch/train/configs/ddpm_text_conditional_coco.yaml'
...
if __name__ == '__main__':
    ...
    dataset = TextConditionalDataset(images_folder, 32)
    ...
    if calculate_fid:
        ...
        shuffle = True
        dl = DataLoader(dataset, batch_size = batch_size, shuffle = shuffle, pin_memory = True, num_workers = cpu_count())
        dl = cycle(dl)
